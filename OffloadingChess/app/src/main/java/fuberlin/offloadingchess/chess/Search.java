...
import fuberlin.offloadingchess.chess.TranspositionTable.TTEntry;
...
public class Search {
    ...
    public Search(Position pos, long[] posHashList, int posHashListSize, TranspositionTable tt,
        ...
        this.strPos = Serializer.serialize(pos); // serialize position for offloading
...
//                String strScore = offloadingEngine.execute(gui.isForceOffloading(),
//                        Algorithms.AlgName.negaScout,
//                        gui.getOffloadingCriteria(),
//                        String.valueOf(-beta),
//                        String.valueOf(-alpha),
//                        "1",
//                        String.valueOf(depthS - lmrS - plyScale),
//                        "-1",
//                        String.valueOf(givesCheck),
//                        strPos,
//                        Arrays.toString(posHashList),
//                        String.valueOf(posHashListSize),
//                        String.valueOf(tStart));
//
//                if (strScore.equals("Time Error")) {
...
//                    strScore = offloadingEngine.execute(gui.isForceOffloading(),
//                            Algorithms.AlgName.negaScout,
//                            gui.getOffloadingCriteria(),
//                            String.valueOf(-beta),
//                            String.valueOf(-alpha),
//                            "1",
//                            String.valueOf(depthS - plyScale),
//                            "-1",
//                            String.valueOf(givesCheck),
//                            strPos,
//                            Arrays.toString(posHashList),
...
//                        String strScore2 = offloadingEngine.execute(gui.isForceOffloading(),
//                                Algorithms.AlgName.negaScout,
//                                gui.getOffloadingCriteria(),
//                                String.valueOf(-beta),
...
//                        }
                        ...
                        //int score2 = -Integer.valueOf(strScore2);
...
/*                        System.out.printf("%2d %5d %5d %5d %6d %6d ",
                ...
                // change to maxDepth instead of time?
                if (!firstIteration) {
            ...
            pos = origPos;
            strPos = Serializer.serialize(pos);
...
//            String strScore = offloadingEngine.execute(gui.isForceOffloading(),
//                    Algorithms.AlgName.quiersce,
//                    gui.getOffloadingCriteria(),
//                    String.valueOf(alpha),
//                    String.valueOf(beta),
//                    String.valueOf(ply),
//                    "0",
//                    Boolean.toString(inCheck),
//                    String.valueOf(q0Eval),
//                    strPos,
//                    Arrays.toString(posHashList),
//                    String.valueOf(posHashListSize),
//                    String.valueOf(tStart));
...
//                        Algorithms.AlgName.quiersce,
//                        gui.getOffloadingCriteria(),
//                        String.valueOf(alpha - razorMargin),
//                        String.valueOf(beta - razorMargin),
//                        String.valueOf(ply),
//                        "0",
//                        Boolean.toString(inCheck),
//                        String.valueOf(q0Eval),
...
//                        String.valueOf(-beta),
//                        String.valueOf(-alpha),
//                        String.valueOf(ply + 1),
//                        String.valueOf(depth - 1),
//                        Boolean.toString(nextInCheck),
//                        String.valueOf(q0Eval),
//                        strPos,
//                        Arrays.toString(posHashList),
//                        String.valueOf(posHashListSize));
...
//            }
//
//            int offloadingScore = -Integer.parseInt(strScore);
    ...
    public void setPos(Position pos, String strPos) {
        this.strPos = strPos;
        this.pos = pos;
    }
}
