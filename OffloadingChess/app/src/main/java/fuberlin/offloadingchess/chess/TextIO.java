...
public class TextIO {
    ...
    /** Parse a FEN string and return a fuberlin.offloadingchess.chess Position object. */
    ...
    /** Return a FEN string corresponding to a fuberlin.offloadingchess.chess Position object. */
    ...
    /**
     * Convert a fuberlin.offloadingchess.chess move to human readable form.
     * @param pos      The fuberlin.offloadingchess.chess position.
    ...
    /**
     * Convert a fuberlin.offloadingchess.chess move string to a Move object.
